<?php
if (!class_exists('GCLPR_Update_Checker')) {

    class GCLPR_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'gclpr_plugin_updates';
