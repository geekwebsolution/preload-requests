    ...
    if(!class_exists("gclpr_prelaod_requests_functions")) {
        ...
        class gclpr_prelaod_requests_functions
        {
            ...
            public function preload_links_callback() {
                ...
                $gclpr_font_urls = (isset($gclpr_options) && !empty($gclpr_options['gclpr_font_options']['font_urls_list'])) ? $gclpr_options['gclpr_font_options']['font_urls_list'] : '';                
                ...
                $gclpr_style_urls   =   (isset($gclpr_options) && !empty($gclpr_options['gclpr_style_options']['style_urls_list'])) ? $gclpr_options['gclpr_style_options']['style_urls_list'] : '';
                ...
                $gclpr_script_urls   =   (isset($gclpr_options) && !empty($gclpr_options['gclpr_script_options']['script_urls_list'])) ? $gclpr_options['gclpr_script_options']['script_urls_list'] : '';
                ...
                $gclpr_image_urls   =   (isset($gclpr_options) && !empty($gclpr_options['gclpr_image_options']['image_urls_list'])) ? $gclpr_options['gclpr_image_options']['image_urls_list'] : '';
                ...
                $gclpr_video_urls   =   (isset($gclpr_options) && !empty($gclpr_options['gclpr_video_options']['video_urls_list'])) ? $gclpr_options['gclpr_video_options']['video_urls_list'] : '';
